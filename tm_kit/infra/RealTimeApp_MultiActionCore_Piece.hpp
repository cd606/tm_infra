...
public:
    MultiActionCore() : RealTimeAppComponents<StateT>::template AbstractAction<std::variant<A0,A1>,B>(), RealTimeAppComponents<StateT>::template ThreadedHandler<std::variant<A0,A1>>(), done_(false) {
    }
...
public:
    MultiActionCore() : RealTimeAppComponents<StateT>::template AbstractAction<std::variant<A0,A1,A2>,B>(), RealTimeAppComponents<StateT>::template ThreadedHandler<std::variant<A0,A1,A2>>(), done_(false) {
    }
    virtual ~MultiActionCore() {
    }
    virtual bool isThreaded() const override final {
...
public:
    MultiActionCore() : RealTimeAppComponents<StateT>::template AbstractAction<std::variant<A0,A1,A2,A3>,B>(), RealTimeAppComponents<StateT>::template ThreadedHandler<std::variant<A0,A1,A2,A3>>(), done_(false) {
    }
    virtual ~MultiActionCore() {
    }
    virtual bool isThreaded() const override final {
...
public:
    MultiActionCore() : RealTimeAppComponents<StateT>::template AbstractAction<std::variant<A0,A1,A2,A3,A4>,B>(), RealTimeAppComponents<StateT>::template ThreadedHandler<std::variant<A0,A1,A2,A3,A4>>(), done_(false) {
    }
    virtual ~MultiActionCore() {
    }
    virtual bool isThreaded() const override final {
...
public:
    MultiActionCore() : RealTimeAppComponents<StateT>::template AbstractAction<std::variant<A0,A1,A2,A3,A4,A5>,B>(), RealTimeAppComponents<StateT>::template ThreadedHandler<std::variant<A0,A1,A2,A3,A4,A5>>(), done_(false) {
    }
    virtual ~MultiActionCore() {
    }
    virtual bool isThreaded() const override final {
...
public:
    MultiActionCore() : RealTimeAppComponents<StateT>::template AbstractAction<std::variant<A0,A1,A2,A3,A4,A5,A6>,B>(), RealTimeAppComponents<StateT>::template ThreadedHandler<std::variant<A0,A1,A2,A3,A4,A5,A6>>(), done_(false) {
    }
    virtual ~MultiActionCore() {
    }
    virtual bool isThreaded() const override final {
...
public:
    MultiActionCore() : RealTimeAppComponents<StateT>::template AbstractAction<std::variant<A0,A1,A2,A3,A4,A5,A6,A7>,B>(), RealTimeAppComponents<StateT>::template ThreadedHandler<std::variant<A0,A1,A2,A3,A4,A5,A6,A7>>(), done_(false) {
    }
    virtual ~MultiActionCore() {
    }
    virtual bool isThreaded() const override final {
...
public:
    MultiActionCore() : RealTimeAppComponents<StateT>::template AbstractAction<std::variant<A0,A1,A2,A3,A4,A5,A6,A7,A8>,B>(), RealTimeAppComponents<StateT>::template ThreadedHandler<std::variant<A0,A1,A2,A3,A4,A5,A6,A7,A8>>(), done_(false) {
    }
    virtual ~MultiActionCore() {
    }
    virtual bool isThreaded() const override final {
...
public:
    MultiActionCore() : RealTimeAppComponents<StateT>::template AbstractAction<std::variant<A0,A1,A2,A3,A4,A5,A6,A7,A8,A9>,B>(), RealTimeAppComponents<StateT>::template ThreadedHandler<std::variant<A0,A1,A2,A3,A4,A5,A6,A7,A8,A9>>(), done_(false) {
    }
    virtual ~MultiActionCore() {
    }
    virtual bool isThreaded() const override final {
