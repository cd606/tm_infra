private:
    ...
    class Maybe2 final : public ActionCore<std::variant<A0,A1>, B, FireOnceOnly> {
    private:
        F f_;
    ...
    public:
        Maybe2(F &&f, DelaySimulator const &delaySimulator) : ActionCore<std::variant<A0,A1>,B,FireOnceOnly>(), f_(std::move(f)), delaySimulator_(delaySimulator) {}
        virtual ~Maybe2() {}
    };
public:
...
private:
    ...
    class Maybe3 final : public ActionCore<std::variant<A0,A1,A2>, B, FireOnceOnly> {
    private:
        F f_;
        DelaySimulator delaySimulator_;
    protected:
    ...
    public:
        Maybe3(F &&f, DelaySimulator const &delaySimulator) : ActionCore<std::variant<A0,A1,A2>,B,FireOnceOnly>(), f_(std::move(f)), delaySimulator_(delaySimulator) {}
        virtual ~Maybe3() {}
    };
public:
...
private:
    ...
    class Maybe4 final : public ActionCore<std::variant<A0,A1,A2,A3>, B, FireOnceOnly> {
    private:
        F f_;
        DelaySimulator delaySimulator_;
    protected:
    ...
    public:
        Maybe4(F &&f, DelaySimulator const &delaySimulator) : ActionCore<std::variant<A0,A1,A2,A3>,B,FireOnceOnly>(), f_(std::move(f)), delaySimulator_(delaySimulator) {}
        virtual ~Maybe4() {}
    };
public:
...
private:
    ...
    class Maybe5 final : public ActionCore<std::variant<A0,A1,A2,A3,A4>, B, FireOnceOnly> {
    private:
        F f_;
        DelaySimulator delaySimulator_;
    protected:
    ...
    public:
        Maybe5(F &&f, DelaySimulator const &delaySimulator) : ActionCore<std::variant<A0,A1,A2,A3,A4>,B,FireOnceOnly>(), f_(std::move(f)), delaySimulator_(delaySimulator) {}
        virtual ~Maybe5() {}
    };
public:
...
private:
    ...
    class Maybe6 final : public ActionCore<std::variant<A0,A1,A2,A3,A4,A5>, B, FireOnceOnly> {
    private:
        F f_;
        DelaySimulator delaySimulator_;
    protected:
    ...
    public:
        Maybe6(F &&f, DelaySimulator const &delaySimulator) : ActionCore<std::variant<A0,A1,A2,A3,A4,A5>,B,FireOnceOnly>(), f_(std::move(f)), delaySimulator_(delaySimulator) {}
        virtual ~Maybe6() {}
    };
public:
...
private:
    ...
    class Maybe7 final : public ActionCore<std::variant<A0,A1,A2,A3,A4,A5,A6>, B, FireOnceOnly> {
    private:
        F f_;
        DelaySimulator delaySimulator_;
    protected:
    ...
    public:
        Maybe7(F &&f, DelaySimulator const &delaySimulator) : ActionCore<std::variant<A0,A1,A2,A3,A4,A5,A6>,B,FireOnceOnly>(), f_(std::move(f)), delaySimulator_(delaySimulator) {}
        virtual ~Maybe7() {}
    };
public:
...
private:
    ...
    class Maybe8 final : public ActionCore<std::variant<A0,A1,A2,A3,A4,A5,A6,A7>, B, FireOnceOnly> {
    private:
        F f_;
        DelaySimulator delaySimulator_;
    protected:
    ...
    public:
        Maybe8(F &&f, DelaySimulator const &delaySimulator) : ActionCore<std::variant<A0,A1,A2,A3,A4,A5,A6,A7>,B,FireOnceOnly>(), f_(std::move(f)), delaySimulator_(delaySimulator) {}
        virtual ~Maybe8() {}
    };
public:
...
private:
    ...
    class Maybe9 final : public ActionCore<std::variant<A0,A1,A2,A3,A4,A5,A6,A7,A8>, B, FireOnceOnly> {
    private:
        F f_;
        DelaySimulator delaySimulator_;
    protected:
    ...
    public:
        Maybe9(F &&f, DelaySimulator const &delaySimulator) : ActionCore<std::variant<A0,A1,A2,A3,A4,A5,A6,A7,A8>,B,FireOnceOnly>(), f_(std::move(f)), delaySimulator_(delaySimulator) {}
        virtual ~Maybe9() {}
    };
public:
...
private:
    ...
    class Maybe10 final : public ActionCore<std::variant<A0,A1,A2,A3,A4,A5,A6,A7,A8,A9>, B, FireOnceOnly> {
    private:
        F f_;
        DelaySimulator delaySimulator_;
    protected:
    ...
    public:
        Maybe10(F &&f, DelaySimulator const &delaySimulator) : ActionCore<std::variant<A0,A1,A2,A3,A4,A5,A6,A7,A8,A9>,B,FireOnceOnly>(), f_(std::move(f)), delaySimulator_(delaySimulator) {}
        virtual ~Maybe10() {}
    };
public:
