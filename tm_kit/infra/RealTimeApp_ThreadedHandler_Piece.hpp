...
public:
    ThreadedHandler(FanInParamMask const &requireMask=FanInParamMask()) : ThreadedHandlerBase<std::variant<A0,A1>>(requireMask) {
    }
...
public:
    ThreadedHandler(FanInParamMask const &requireMask=FanInParamMask()) : ThreadedHandlerBase<std::variant<A0,A1,A2>>(requireMask) {
    }
    virtual ~ThreadedHandler() {
    }
private:
...
public:
    ThreadedHandler(FanInParamMask const &requireMask=FanInParamMask()) : ThreadedHandlerBase<std::variant<A0,A1,A2,A3>>(requireMask) {
    }
    virtual ~ThreadedHandler() {
    }
private:
...
public:
    ThreadedHandler(FanInParamMask const &requireMask=FanInParamMask()) : ThreadedHandlerBase<std::variant<A0,A1,A2,A3,A4>>(requireMask) {
    }
    virtual ~ThreadedHandler() {
    }
private:
...
public:
    ThreadedHandler(FanInParamMask const &requireMask=FanInParamMask()) : ThreadedHandlerBase<std::variant<A0,A1,A2,A3,A4,A5>>(requireMask) {
    }
    virtual ~ThreadedHandler() {
    }
private:
...
public:
    ThreadedHandler(FanInParamMask const &requireMask=FanInParamMask()) : ThreadedHandlerBase<std::variant<A0,A1,A2,A3,A4,A5,A6>>(requireMask) {
    }
    virtual ~ThreadedHandler() {
    }
private:
...
public:
    ThreadedHandler(FanInParamMask const &requireMask=FanInParamMask()) : ThreadedHandlerBase<std::variant<A0,A1,A2,A3,A4,A5,A6,A7>>(requireMask) {
    }
    virtual ~ThreadedHandler() {
    }
private:
...
public:
    ThreadedHandler(FanInParamMask const &requireMask=FanInParamMask()) : ThreadedHandlerBase<std::variant<A0,A1,A2,A3,A4,A5,A6,A7,A8>>(requireMask) {
    }
    virtual ~ThreadedHandler() {
    }
private:
...
public:
    ThreadedHandler(FanInParamMask const &requireMask=FanInParamMask()) : ThreadedHandlerBase<std::variant<A0,A1,A2,A3,A4,A5,A6,A7,A8,A9>>(requireMask) {
    }
    virtual ~ThreadedHandler() {
    }
private:
