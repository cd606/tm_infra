private:
    ...
    public:
        Kleisli2(F &&f, FanInParamMask const &requireMask=FanInParamMask(), bool fireOnceOnly=false) : ActionCore<std::variant<A0,A1>,B,Threaded>(requireMask, fireOnceOnly), f_(std::move(f)) {}
        virtual ~Kleisli2() {}
    };
public:
...
private:
    ...
    public:
        Kleisli3(F &&f, FanInParamMask const &requireMask=FanInParamMask(), bool fireOnceOnly=false) : ActionCore<std::variant<A0,A1,A2>,B,Threaded>(requireMask, fireOnceOnly), f_(std::move(f)) {}
        virtual ~Kleisli3() {}
    };
public:
...
private:
    ...
    public:
        Kleisli4(F &&f, FanInParamMask const &requireMask=FanInParamMask(), bool fireOnceOnly=false) : ActionCore<std::variant<A0,A1,A2,A3>,B,Threaded>(requireMask, fireOnceOnly), f_(std::move(f)) {}
        virtual ~Kleisli4() {}
    };
public:
...
private:
    ...
    public:
        Kleisli5(F &&f, FanInParamMask const &requireMask=FanInParamMask(), bool fireOnceOnly=false) : ActionCore<std::variant<A0,A1,A2,A3,A4>,B,Threaded>(requireMask, fireOnceOnly), f_(std::move(f)) {}
        virtual ~Kleisli5() {}
    };
public:
...
private:
    ...
    public:
        Kleisli6(F &&f, FanInParamMask const &requireMask=FanInParamMask(), bool fireOnceOnly=false) : ActionCore<std::variant<A0,A1,A2,A3,A4,A5>,B,Threaded>(requireMask, fireOnceOnly), f_(std::move(f)) {}
        virtual ~Kleisli6() {}
    };
public:
...
private:
    ...
    public:
        Kleisli7(F &&f, FanInParamMask const &requireMask=FanInParamMask(), bool fireOnceOnly=false) : ActionCore<std::variant<A0,A1,A2,A3,A4,A5,A6>,B,Threaded>(requireMask, fireOnceOnly), f_(std::move(f)) {}
        virtual ~Kleisli7() {}
    };
public:
...
private:
    ...
    public:
        Kleisli8(F &&f, FanInParamMask const &requireMask=FanInParamMask(), bool fireOnceOnly=false) : ActionCore<std::variant<A0,A1,A2,A3,A4,A5,A6,A7>,B,Threaded>(requireMask, fireOnceOnly), f_(std::move(f)) {}
        virtual ~Kleisli8() {}
    };
public:
...
private:
    ...
    public:
        Kleisli9(F &&f, FanInParamMask const &requireMask=FanInParamMask(), bool fireOnceOnly=false) : ActionCore<std::variant<A0,A1,A2,A3,A4,A5,A6,A7,A8>,B,Threaded>(requireMask, fireOnceOnly), f_(std::move(f)) {}
        virtual ~Kleisli9() {}
    };
public:
...
private:
    ...
    public:
        Kleisli10(F &&f, FanInParamMask const &requireMask=FanInParamMask(), bool fireOnceOnly=false) : ActionCore<std::variant<A0,A1,A2,A3,A4,A5,A6,A7,A8,A9>,B,Threaded>(requireMask, fireOnceOnly), f_(std::move(f)) {}
        virtual ~Kleisli10() {}
    };
public:
