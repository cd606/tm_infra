private:
    ...
    class Kleisli2 final : public ActionCore<std::variant<A0,A1>, B, Threaded> {
    private:
        F f_;
    protected:
    ...
    public:
        Kleisli2(F &&f, FanInParamMask const &requireMask=FanInParamMask()) : ActionCore<std::variant<A0,A1>,B,Threaded>(requireMask), f_(std::move(f)) {}
        virtual ~Kleisli2() {}
    };
public:
    template <class A0, class A1, class F>
    static auto kleisli2(F &&f, bool threaded=false, FanInParamMask const &requireMask=FanInParamMask()) -> std::shared_ptr<Action<std::variant<A0,A1>,typename decltype(f(0,std::move(*((InnerData<A0> *) nullptr)),std::move(*((InnerData<A1> *) nullptr))))::value_type::ValueType>> {
        if (threaded) {
            return std::make_shared<Action<std::variant<A0,A1>,typename decltype(f(0,std::move(*((InnerData<A0> *) nullptr)),std::move(*((InnerData<A1> *) nullptr))))::value_type::ValueType>> ( new Kleisli2<A0,A1,typename decltype(f(0,std::move(*((InnerData<A0> *) nullptr)),std::move(*((InnerData<A1> *) nullptr))))::value_type::ValueType,F,true>(std::move(f), requireMask) );
        } else {
            return std::make_shared<Action<std::variant<A0,A1>,typename decltype(f(0,std::move(*((InnerData<A0> *) nullptr)),std::move(*((InnerData<A1> *) nullptr))))::value_type::ValueType>> ( new Kleisli2<A0,A1,typename decltype(f(0,std::move(*((InnerData<A0> *) nullptr)),std::move(*((InnerData<A1> *) nullptr))))::value_type::ValueType,F,false>(std::move(f), requireMask) );
        }
    }
private:
    template <class A0, class A1, class A2, class B, class F, bool Threaded>
    class Kleisli3 final : public ActionCore<std::variant<A0,A1,A2>, B, Threaded> {
    private:
        F f_;
    protected:
    ...
    public:
        Kleisli3(F &&f, FanInParamMask const &requireMask=FanInParamMask()) : ActionCore<std::variant<A0,A1,A2>,B,Threaded>(requireMask), f_(std::move(f)) {}
        virtual ~Kleisli3() {}
    };
public:
    template <class A0, class A1, class A2, class F>
    static auto kleisli3(F &&f, bool threaded=false, FanInParamMask const &requireMask=FanInParamMask()) -> std::shared_ptr<Action<std::variant<A0,A1,A2>,typename decltype(f(0,std::move(*((InnerData<A0> *) nullptr)),std::move(*((InnerData<A1> *) nullptr)),std::move(*((InnerData<A2> *) nullptr))))::value_type::ValueType>> {
        if (threaded) {
...
private:
    ...
    class Kleisli4 final : public ActionCore<std::variant<A0,A1,A2,A3>, B, Threaded> {
    private:
        F f_;
    protected:
...
private:
    ...
    class Kleisli5 final : public ActionCore<std::variant<A0,A1,A2,A3,A4>, B, Threaded> {
    private:
        F f_;
    protected:
...
private:
    ...
    class Kleisli6 final : public ActionCore<std::variant<A0,A1,A2,A3,A4,A5>, B, Threaded> {
    private:
        F f_;
    protected:
...
private:
    ...
    class Kleisli7 final : public ActionCore<std::variant<A0,A1,A2,A3,A4,A5,A6>, B, Threaded> {
    private:
        F f_;
    protected:
...
private:
    ...
    class Kleisli8 final : public ActionCore<std::variant<A0,A1,A2,A3,A4,A5,A6,A7>, B, Threaded> {
    private:
        F f_;
    protected:
...
private:
    ...
    class Kleisli9 final : public ActionCore<std::variant<A0,A1,A2,A3,A4,A5,A6,A7,A8>, B, Threaded> {
    private:
        F f_;
    protected:
...
private:
    ...
    class Kleisli10 final : public ActionCore<std::variant<A0,A1,A2,A3,A4,A5,A6,A7,A8,A9>, B, Threaded> {
    private:
        F f_;
    protected:
